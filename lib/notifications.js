...
// Conditionally import twilio only if credentials exist
let twilio = null;
...
try {
  ...
  // Only try to import and initialize if we have valid credentials
  ...
  // Silently ignore twilio initialization - it's optional
  twilioClient = null;
}
